...
![circuit diagram](./Images/button_multiplexing_lightmode.png#gh-light-mode-only | width=100)
<img src="./Images/button_multiplexing_lightmode.png#gh-light-mode-only" "width=100">
![circuit diagram](./Images/button_multiplexing_darkmode.png#gh-dark-mode-only | width=100)
